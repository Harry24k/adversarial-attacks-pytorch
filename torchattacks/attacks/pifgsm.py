...
class PIFGSM(Attack):
    ...
    def project_noise(self, images, stack_kern, padding_size):
        images = F.conv2d(images, stack_kern, padding=(
    ...
    def graph(self, images, labels, images_min, images_max):
        ...
        gamma = alpha_beta
        stack_kern, padding_size = self.project_kern(3)
        ...
        for _ in range(num_iter):
            ...
            projection = gamma * \
                torch.sign(self.project_noise(
                    cut_noise, stack_kern, padding_size))
